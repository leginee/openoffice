...
public:
	...
	VALUETYPE Get_shift(VALUETYPE remainder) {
		return bit_mask << bits_per_pixel* get_position(msb_first, remainder);
	}
 ...
 * greylevelformats:PixelFormatTraitsTemplate_PackedPalette
 * paletteformats
 * bmpdemo
 * Package_inc.mk
 */
